...
| `internal-spire-server-bottom-turtle-ha-a.dynamicRegistration.nameOverride`                                                           | The name override to use to contact the server           | `internal-server`                                                             |
...
| `internal-spire-server-bottom-turtle-ha-b.dynamicRegistration.nameOverride`                                                           | The name override to use to contact the server                 | `internal-server`                                                             |
