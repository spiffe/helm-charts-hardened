...
| `image.tag`                                   | Overrides the image tag whose default is the chart appVersion                                                                                                 | `spiffefs2`                                               |
| `mountPath`                                   | Host directory spiffefs mounts its filesystem on. Must match the agentSocketPath directory of the spiffe-csi-driver instance publishing it.                   | `/run/spire/k8s/spiffefs`                                 |
