...
| `validatingAdmissionPolicy.allowedNamespaces` | Namespaces whose pods may mount this driver, besides the chart's own                                                                                                                    | `[]`                                        |
...
| `nodeDriverRegistrar.securityContext`         | Security context for the nodeDriverRegistrar container                                                                                                                                  | `{}`                                        |
