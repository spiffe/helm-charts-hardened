...
| `ingress.controllerType`           | Specify what type of ingress controller you're using to add the necessary annotations accordingly. If other, none will be added. Must be one of [ingress-nginx, other]. | `other`                                                                          |
