...
| `ingress.host`                     | Host to use for autogenerated rules. If no '.' is in host, trustDomain is automatically appended.                                                                                                                 | `tornjak-frontend`                                                               |
| `ingress.tlsSecret`                | secret to use for autogenerated rules.                                                                                                                                                                            | `""`                                                                             |
| `ingress.hosts`                    | Host paths for ingress Tornjak frontend service. If emtpy, rules will be built based on the host var.                                                                                                             | `[]`                                                                             |
