...
| `gatewayAPI.backendTLS.enabled`           | Emit a BackendTLSPolicy (reencrypt) for terminated routes whose backend serves HTTPS                                                                                                                                                    | `nil`                                                                            |
| `gatewayAPI.backendTLS.caCertificateRefs` | ConfigMap refs holding the backend CA. Defaults to the SPIRE bundle configmap.                                                                                                                                                          | `[]`                                                                             |
