...
| `ingress.controllerType`           | Specify what type of ingress controller your using. If other, no additional annotations will be added to your ingresses. Must be one of [other, ingress-nginx]. | `other`                                                                          |
