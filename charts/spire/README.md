...
| `global.spire.ingressControllerType`    | Specify what type of ingress controller your using. If generic, no additional annotations will be added to your ingresses. Must be one of [gemeric]. | `""`                         |
