...
| `global.spire.useRecommended.securityContexts` | Set to true to use our recommendations for pod and container securityContexts                                                                                                                                                          | `false`           |
| `global.spire.useRecommended.priorityClasses`  | Set to true to use our recommendations for pod priority classes                                                                                                                                                                        | `false`           |
| `global.spire.useRecommended.namespaces`       | Set to true to use our recommendations for installing across namespaces                                                                                                                                                                | `false`           |
