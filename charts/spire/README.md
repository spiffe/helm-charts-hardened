...
| `spire-server.kind`                      | Define SPIRE server kind. Can be one of [statefulset, deployment, none]. Setting to deployment is experimental. None will deploy everything except the server itself. | `statefulset` |
